...
def run():
    wrong_reports = StudentReport.objects.filter(payment=1, territorial_manager__isnull=True, start_date__in=('2023-09-01','2023-09-04','2023-09-11'), business="programming").all()
