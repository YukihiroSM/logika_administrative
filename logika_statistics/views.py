...
def consolidation_report(request):
    ...
    html_template = loader.get_template("logika_statistics/consolidation_report.html")
    return HttpResponse(html_template.render(context, request))
...
def consolidation_issue_close(request, issue_id):
    html_template = loader.get_template("logika_statistics/consolidation_close_reason.html")
    issue: LessonsConsolidation = LessonsConsolidation.objects.filter(
        id=issue_id
    ).first()
    user_role = get_user_role(request.user)
...
def programming_teacher_report_updated(request):
    ...
    html_template = loader.get_template(
        "logika_statistics/report_programming_teacher_updated.html")
    return HttpResponse(html_template.render(context, request))
...
def english_new(request):
    ...
    html_template = loader.get_template("logika_statistics/report_english_new_admin.html")
    return HttpResponse(html_template.render(context, request))
...
def programming_tutor_new(request):
    ...
    html_template = loader.get_template(
        "logika_statistics/report_programming_tutor_new_admin.html")
    return HttpResponse(html_template.render(context, request))
...
def english_tutor_new(request):
    ...
    html_template = loader.get_template(
        "logika_statistics/report_english_tutor_new_admin.html")
    return HttpResponse(html_template.render(context, request))
...
def programming_teacher_new(request):
    ...
    html_template = loader.get_template(
        "logika_statistics/report_programming_teacher_admin.html")
    return HttpResponse(html_template.render(context, request))
...
def english_teacher_new(request):
    ...
    html_template = loader.get_template(
        "logika_statistics/report_english_teacher_admin.html")
    return HttpResponse(html_template.render(context, request))
...
def issues_new(request):
    ...
    html_template = loader.get_template("logika_statistics/issues_new.html")
    context = {
        "segment": "issues",
        "user_role": user_role,
        "user_name": user_name,
...
def issues_tutors(request):
    ...
    html_template = loader.get_template("logika_statistics/issues_tutors.html")
    context = {
        "segment": "issues",
        "user_role": user_role,
...
def revert_issue(request, issue_id):
    ...
    html_template = loader.get_template("logika_statistics/revert_issue.html")
...
def add_teacher_for_group(request, issue_id):
    html_template = loader.get_template("logika_statistics/add_teacher.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
...
def add_student_id(request, issue_id):
    html_template = loader.get_template("logika_statistics/add_student_id.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
...
def add_location(request, issue_id):
    html_template = loader.get_template("logika_statistics/add_location.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
...
def add_client_manager(request, issue_id):
    html_template = loader.get_template("logika_statistics/add_client_manager.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    lms_id = issue.issue_description.split(";")[0]
    if request.method == "POST":
...
def assign_issue(request, issue_id):
    html_template = loader.get_template("logika_statistics/assign_issue.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    lms_id = issue.issue_description.split(";")[0]
    if request.method == "POST":
...
def assign_issue_tutor(request, issue_id):
    html_template = loader.get_template("logika_statistics/assign_issue_tutor.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    if request.method == "POST":
...
def close_issue_reason_new(request, issue_id):
    html_template = loader.get_template("logika_statistics/reason_new.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    user_role = get_user_role(request.user)
    url = "close"
    lms_id = issue.issue_description.split(";")[0]
...
def create_student_amo_ref_new(request, issue_id):
    html_template = loader.get_template("logika_statistics/create_amo_ref.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    lms_id = issue.issue_description.split(";")[0]
    if request.method == "POST":
...
def close_no_actions_issue_reason_new(request, issue_id):
    html_template = loader.get_template("logika_statistics/reason.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
    user_role = get_user_role(request.user)
    user_name = f"{request.user.last_name} {request.user.first_name}"
    lms_id = issue.issue_description.split(";")[0]
...
def check_group_location(request, issue_id):
    html_template = loader.get_template("logika_statistics/unknown_location.html")
    issue: Issue = Issue.objects.filter(id=issue_id).first()
